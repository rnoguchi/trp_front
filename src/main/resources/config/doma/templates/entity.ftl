...
<#list lib.commonEntityHash?values as commonEntityImportName>
import ${commonEntityImportName};
</#list>
...
public class <#if entityPrefix??>${entityPrefix}</#if>${simpleName}<#if entitySuffix??>${entitySuffix}</#if><#if superclassSimpleName??> extends ${superclassSimpleName}</#if> <#list lib.commonEntityHash?keys as commonEntityName>extends ${commonEntityName}</#list> {
<#list ownEntityPropertyDescs as property>

  <#if property.columnName == "updated_at">
    <#continue>
  </#if>
  <#if property.columnName == "created_at">
    <#continue>
  </#if>
  <#if property.columnName == "updated_user">
    <#continue>
  </#if>
  <#if property.columnName == "created_user">
    <#continue>
  </#if>
